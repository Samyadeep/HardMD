...
def get_args_parser():
    ...
    parser.add_argument("--nEpisode", default=2000, type=int,
                        help="Number of episodes for training / testing for each dataset.")
    ...
    # 
    parser.add_argument('--weighted_step_size', default=0.01, type = float, help='Weighted Step Size')
      
    # Adapter dimension
    parser.add_argument('--adapter_dim', default=32, type = int, help='Adapter Dimension')

    parser.add_argument('--adapter', action='store_true', help='Whether to use adapter or not')
    
    # 
    parser.add_argument('--optimizer_epoch', default=200, type = int, help='Optimizer Epoch')
    parser.add_argument('--kmax', default = 50, type = int, help = 'kmax for sparsity')


    parser.add_argument('--sup', default = 5, type = int, help = 'Support Set selection')
    parser.add_argument('--n_query', default = 10, type = int, help = 'Support Set selection')

    parser.add_argument('--query_opt', default = 5, type = int, help = 'Number of query sets to run the algorithm for extracting hard episodes')
    parser.add_argument('--way_opt', default = 5, type = int, help = 'Optimization number of ways')

    # 
    parser.add_argument('--train_only_norm', action='store_true', help='Whether to use adapter or not')

    # Joint optimization
    parser.add_argument('--joint_opt', action='store_true', help='Whether to use joint optimization or not')
    parser.add_argument('--clamp', action='store_true', help='Whether to use joint optimization or not')

    parser.add_argument('--probe_dataset', default='objectnet', type=str,  help='Datasets')
    parser.add_argument('--easy', action = 'store_true',  help='If easy tasks need to be extracted')

    parser.add_argument('--md_sampling', action = 'store_true',  help='If meta-datasets sampling process can be used')
