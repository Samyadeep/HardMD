...
class FullMetaDatasetH5(torch.utils.data.Dataset):
    def __init__(self, args, split=Split['TRAIN']):
        ...
        # Length of the episodic configuration -- 2000 * 8 = 16000 datasets in total
    ...
    def get_next(self, source, class_id, idx):
        ...
        # Modified ####### 30 June
        self.class_h5_dict[source][class_id].close()
        self.class_h5_dict[source][class_id] = None
    ...
    def __getitem__(self, idx):
        ...
        return support_images, support_labels, query_images, query_labels#, source # Changed
